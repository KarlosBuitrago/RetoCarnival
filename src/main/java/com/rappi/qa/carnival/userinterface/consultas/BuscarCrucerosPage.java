...
public class BuscarCrucerosPage {
    ...
    public static final Target TEXTO_BUSQUEDA1 = Target
            .the("texto busqueda")
    ...
    public static final Target TEXTO_BUSQUEDA = Target
            .the("texto busqueda")
            .locatedBy("//*[@id='ccl-refresh-homepage']/div/div/div/div/div/ccl-cruise-search/div[{0}]/ccl-view-result-container/div/ccl-view-result-list/article[1]/ccl-view-result-list-item/div/div/div[1]/div/div/ccl-cruise-search-glance/div/span/span/span[2]/span[1]");
